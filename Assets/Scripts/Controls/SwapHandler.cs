...
{
    public static SwapHandler Instance { get; private set; }
    ...
    {   
        ...
        {    
            ...
            if (firstTochPos != null && MovementJoystick.Instance.IsDragingStick())
            {
                firstTochPos = null;
                return;
            }
    ...
    {
        EventSystem eventSystem = EventSystem.current; return (eventSystem.IsPointerOverGameObject(fingerId) && eventSystem.currentSelectedGameObject != null && eventSystem.currentSelectedGameObject.TryGetComponent<IgnoreSwipe>(out IgnoreSwipe ignoreSwipe));
    }
}
